...
public class Asteroid extends Place {
	...
	public void getDrilled() throws Exception {
		Logger.call("Model.Asteroid.getDrilled", "");
		if(layers == 0) {
	...
	public Material mineCore() {
		Logger.call("Model.Asteroid.mineCore", "");
		if(core != null && layers == 0) { //edit: balint
			Material temp = core;
			core.mined();

			core = null;
			Logger.ret("Model.Material =" + temp.toString());
			return temp;
		}
		Logger.ret("null");
		return null;
	...
	public boolean replaceCore(Material m) throws Exception {
		Logger.call("Model.Asteroid.replaceCore", "Model.Material = " + m);
		if(core == null) {
		core = m;
		if(isNearSun)
			coreSunEffectTrigger();
	...
	public void checkNearSun() throws Exception {
		Logger.call("Model.Asteroid.checkNearSun", "");
	...
	public Collection<Place> getNeighbours() {
		Logger.call("Model.Asteroid.getNeighbours", "");
	...
	public Collection<Entity> getEntities() {
		Logger.call("Model.Asteroid.getEntities", "");
		Logger.ret("entities");
		return entities;
	}
	...
	public void removeGate(Gate g) {
		Logger.call("Model.Asteroid.removeGate ", "Model.Gate = " + g);
	...
	public void setNearSun(boolean b) throws Exception {
		Logger.call("Model.Asteroid.setNearSun", "isNarSun = " + b);
		isNearSun = b;
		if(isNearSun) {
			coreSunEffectTrigger();
		}
	...
	private void coreSunEffectTrigger() throws Exception {
		Logger.call("Model.Asteroid.coreSunEffectTrigger", "");
		if(isNearSun && layers == 0 && core != null) {
				core.nearSunEffect();
		}
		Logger.ret("");
	}
	...
	public void solarStorm() {
		Logger.call("Model.Asteroid.solarStorm", "");
	...
	public void setCore(Material m) {
		Logger.call("Model.Asteroid.setCore", "Model.Material = " + m);
		core = m;
		if(core != null)
	...
	public boolean getNearSun() {
		Logger.call("Model.Asteroid.getNearSun", "");
	...
	public void addEntity(Entity e) {
		Logger.call("Model.Asteroid.addEntity", "Model.Entity = " + e);
		try{
	...
	public ArrayList<Material> allMaterial() {
		Logger.call("Model.Asteroid.allMaterial", "");
	...
	public void setLayer(int n){
		Logger.call("Model.Asteroid.setLayer", "layers = " + n);
		layers=n;
		Logger.ret("");
	}
	 ...
	 */
	public int getLayer(){
		Logger.call("Model.Asteroid.getLayer", "");
		Logger.ret(""+layers);
		return layers;
	}
	...
	public void addGate(Gate g) {
		Logger.call("Model.Asteroid.addGate ", "Model.Gate = " + g);
		gates.add(g);
		g.setPosition(this);
		Logger.ret("");
	}
