...
//
//  @ Project : projlab
//  @ File Name : Model.Astronaut.java
//  @ Date : 2021. 03. 29.
//  @ Author : Levente Vigh
//
//
...
public class Astronaut extends Entity implements IDrill, IMine {
	...
	public Astronaut(Asteroid a) throws Exception {
		super(a);
		if(null == a)
			throw new Exception("Argument passed to Model.Astronaut.ctor is null!");
		gates = new ArrayList<Gate>();
		collectedMaterials = new ArrayList<Material>();
		numOfAstronauts++;
		name = "Model.Astronaut " + numOfAstronauts;
	}
	...
	public void move() throws Exception {
		Logger.call("Model.Astronaut.move()","");
	...
	public void drill() throws Exception {
		Logger.call("Model.Astronaut.drill()","");
	...
	public void craftRobot() throws Exception {
		Logger.call("Model.Astronaut.craftRobot()","");
	...
	public void craftGate() throws Exception {
		Logger.call("Model.Astronaut.craftGate()","");
	...
	public void mine() throws Exception {
		Logger.call("Model.Astronaut.mine()","");
	...
	public void deployGate() throws Exception {
		Logger.call("Model.Astronaut.deployGate()","");
		...
		//Model.Gate[] portalGates = (Model.Gate[]) gates.toArray();
	...
	public void step() throws Exception {
		Logger.call("Model.Astronaut.step()","");
	...
	public void explosionEffect() {
		Logger.call("Model.Astronaut.explosionEffect()","");
	...
	public void putMaterialInAsteroid() throws Exception {
		Logger.call("Model.Astronaut.putMaterialInAsteroid()","");

		ArrayList<Material> materials = new ArrayList<Material>(collectedMaterials);

		//ha ures az inventorynk kivetelt dobunk
		if(materials.size() == 0)
			throw new Exception("Model.Astronaut has no material in its inventory.");
	...
	public Collection<Material> getInventory() {
		Logger.call("Model.Astronaut.getInventory()","");
	...
	public Collection<Gate> getGates() {
		Logger.call("Model.Astronaut.getGates()","");
	...
	public void addGate(Gate g) throws Exception {
		...
		Logger.call("Model.Astronaut.addGate()","g: " + s);

		if(null == g)
			throw new Exception("Argument passed to Model.Astronaut.addGate(...) is null!");
		//ha nincs eleg hely az inventoryban kivetelt dobunk
		if(gates.size() > 1)
			throw new Exception("Missing place for new teleport gate(s) in inventory!");
	...
	public void addMaterial(Material m) throws Exception {
		...
		Logger.call("Model.Astronaut.addMaterial()","m: " + s);

		//ha ures volt a mag nem taroljuk el
		if(null == m)
			throw new Exception("Argument passed to Model.Astronaut.addMaterial(...) is null!");
		if(collectedMaterials.size() == 10)
			throw new Exception("Missing place for new material in inventory!");
