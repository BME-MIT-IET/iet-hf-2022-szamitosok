...
public abstract class Entity {
	...
	public void setPosition(Asteroid a) throws Exception {
		...
		Logger.call("Enity.setPosition()", "Model.Asteroid a: " + s);

		if(null == a)
			throw new Exception("Argument passed to Model.Entity.setPosition(...) is null");
	...
	public void moveTo(Place destination) throws Exception {
		...
		if(null == destination)
			throw new Exception("Argument passed to Model.Entity.moveTo(...) is null");
